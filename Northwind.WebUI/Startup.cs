...
//                Environment.GetEnvironmentVariable("NORTHWIND_DATABASE", EnvironmentVariableTarget.Process);
//            var settingsConnectingString = Configuration.GetConnectionString("NorthwindDatabase");
//            var connectionString = string.IsNullOrEmpty(envConnectionString)
//                ? settingsConnectingString
//                : envConnectionString;
            
            services.AddDbContext<NorthwindDbContext>(options =>
                options.UseSqlServer(Environment.GetEnvironmentVariable("NORTHWIND_DATABASE", EnvironmentVariableTarget.Process)));
